...
Screenshot first, phone thirty seconds later — the man's twenty-year etiquette. Make me laugh first, then call to laugh together. That day the bell led. There is exactly one reason the etiquette breaks. Something not funny has happened.
...
There was no avoiding the Salon. The exhibition of the refused canvases — and its back page, where the painters gave up submitting altogether and mounted a jury-less show of their own; that chapter belongs to last year's household research. What Sonnet had brought home was exactly that. The web's Salon des Refusés. Not the ones shut out of the exhibition hall — the ones who had gone on existing outside it the whole time. In an age of uniformity, diversity does not die; it goes outside — the verdict notebook's own sentence, and the correspondent had assembled its street directory in a day.
