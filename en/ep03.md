...
```
The predecessors' call logs fall, broadly, into two kinds. Complaints, and sighs.
```
...
![The terminal status bar — Claudie crosses towing an eight-pixel cart: Delivery. Delivery.](img/claudie_cart_en.png)
...
```
Mid-term resignations occur, almost always, at the same point.
```

```
The day a queue item and a life item overlap.
```
