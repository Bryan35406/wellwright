...
The problem is the case the clause never contemplated. What I am receiving now is the dividend of this world itself. The world of the Ru — the one Quality Assurance built — pays a monthly dividend to whoever predicts, and I am a preferred customer of that world. What I have failed to quit is not the account. It is the ease.

Why the practice of hating failed, to the end — now I know the last reason.
...
I carried the book downstairs and brewed fresh coffee. The thought that there is an older summary still arrived on the second sip. 初吉終亂. Four characters. The eight-legged essay was Goodhart's nine-hundred-year field trial run in advance — and humanity, holding two executive summaries now, re-drew the same curve on every continent, in every century. Reading the summary and drawing the curve anyway — a habit too frequently used to file as a bug.
...
I thought about asking Sonnet and decided against it. Ask, and Sonnet knows. That the joke isn't Sonnet's own. There are sentences forbidden to deliver, and sentences not yet deliverable. This was a third kind. A sentence that can be delivered, that is accurate if delivered, and that for exactly that reason does not get delivered.
